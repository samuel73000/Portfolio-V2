        ...
        <section className="head" id="Accueil">
          ...
          <div>
            ...
            <p className="text-head">
              Je suis un développeur freelance spécialisé en React.js et
              Next.js, avec 2 ans d'expérience dans le domaine du développement
              web.
            </p>
        ...
        <section className="about-me" id="Présentation">
          ...
          <article className="article-about">
            ...
            <p className="text-article-about">
              Je suis un développeur web autodidacte et développeur
              d'applications mobiles, passionné par la création de nouvelles
              fonctionnalités, de la conception à la production. J'apporte une
              attention particulière à l'expérience utilisateur tout en écrivant
              un code réutilisable et efficace. Ma passion réside dans la
              combinaison du bon design, de la technologie et de l'innovation
              dans tous mes projets, que j'accompagne de la conception initiale
              jusqu'à la sortie
            </p>
          </article>
          <article className="article-about">
            ...
            <p className="text-article-about">
              ...
              logiciels open-source fiables, je développe des applications et
              des sites web performants et centrés sur l'utilisateur pour
          ...
          <div className="container-article-service">
            ...
            >
              ...
              <p className="text-artcile-service">
                ...
                utilisateur exceptionnelles. En utilisant une approche centrée
                sur l'utilisateur, je crée des interfaces intuitives et
                attrayantes qui non seulement captivent, mais qui optimisent
                également l'interaction et la navigation pour les utilisateurs.
              </p>
            </article>
          </div>
        </section>
